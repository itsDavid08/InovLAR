    ...
    return (
        <div style={{ minHeight: "100dvh", background: "#fff", display: "flex", flexDirection: "column", fontFamily: "system-ui" }}>
            <div style={{ padding: "12px 18px 14px", borderBottom: "1px solid #eef1f6", flex: "0 0 auto" }}>
                <div style={{ font: "800 22px system-ui", color: "#0f172a" }}>Pedidos Pendentes</div>
                <div style={{ font: "600 14px system-ui", color: "#64748b" }}>{all.length} pedidos · atualizado agora</div>
            </div>
            <div style={{ flex: 1, overflowY: "auto", padding: "14px", paddingBottom: 88, display: "flex", flexDirection: "column", gap: 12 }}>
                ...
                {all.length === 0 && (
                    <div style={{ textAlign: "center", color: "#94a3b8", font: "600 16px system-ui", padding: "40px 0" }}>Sem pedidos pendentes</div>
                )}
            </div>
        </div>
    );
