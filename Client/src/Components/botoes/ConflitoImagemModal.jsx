        ...
        >
            ...
            >
                <div className="flex items-center gap-3">
                    ...
                    <h2 className="font-headline-md text-xl font-bold text-on-surface">Imagem já existe</h2>
                </div>
                <p className="font-body-md text-body-md text-on-surface-variant">
                    Já existe uma imagem com o nome{" "}
                    <strong className="text-on-surface break-all">{nome}</strong>. O que pretende fazer?
                </p>
