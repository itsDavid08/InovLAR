    ...
    return (
        <StaffShell sidebar={<StaffSidebar />}>
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-end gap-4 mb-6">
                <div>
                    <h2 className="font-display-lg text-3xl md:text-2xl font-bold text-on-surface mb-1">{t.botoes.listTitle}</h2>
                    <p className="font-body-md text-body-md text-on-surface-variant">{t.botoes.listSubtitle}</p>
                </div>
                <div className="flex items-center gap-3 shrink-0">
                    <SearchInput
                        value={searchQuery}
                        onChange={onSearchChange}
                        placeholder={t.botoes.searchPlaceholder}
                    ...
                    >
                        ...
                        <div className="flex items-center flex-col text-center mt-2 sm:mt-4">
                            ...
                            <span className="mt-2 bg-surface-container text-on-surface-variant px-2 py-1 rounded text-xs font-staff-mono font-bold truncate max-w-full">
                                {botao.categoria || t.common.noCategory}
                            </span>
                        </div>
                    </div>
                ))}
